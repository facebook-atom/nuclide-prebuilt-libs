...
TARGETS=(
  ...
  "--target_platform=linux --runtime=electron --target=6.0.12"
  ...
  "--target_platform=darwin --runtime=electron --target=6.0.12"
  ...
  "--target_platform=win32 --runtime=electron --target=6.0.12"
)
