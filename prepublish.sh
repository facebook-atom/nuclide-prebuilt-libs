...
TARGETS=(
  ...
  "--target_platform=linux --runtime=electron --target=7.3.1"
  ...
  "--target_platform=darwin --runtime=electron --target=7.3.1"
  ...
  "--target_platform=win32 --runtime=electron --target=7.3.1"
)
