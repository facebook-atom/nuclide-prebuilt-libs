...
TARGETS=(
  ...
  "--target_platform=linux --runtime=electron --target=10.13.0"
  ...
  "--target_platform=darwin --runtime=electron --target=10.13.0"
  ...
  "--target_platform=win32 --runtime=electron --target=10.13.0"
