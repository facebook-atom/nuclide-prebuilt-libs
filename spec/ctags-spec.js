...
describe('ctags', function() {
  ...
  tagsFile = null;
  beforeEach(function() {
    return tagsFile = path.join(__dirname, 'fixtures', 'tags');
  });
  describe('.findTags(name, options, callback)', function() {
    ...
    describe('when partialMatch is set to true', function() {
      return it('returns tags that partially match the name', function() {
        var callback;
        callback = jasmine.createSpy('callback');
        ctags.findTags(tagsFile, 'dup', {
          partialMatch: true
        }, callback);
        waitsFor(function() {
          return callback.callCount === 1;
    ...
    return describe('when caseInsensitive is set to true', function() {
      return it('returns tags that match the name case insensitively', function() {
        var callback, tags;
        callback = jasmine.createSpy('callback');
        tags = ctags.findTags(tagsFile, 'callmemaybe', {
  ...
  describe('.createReadStream(tagsFilePath)', function() {
    ...
    return it("emits an error event when the tags file does not exist", function() {
      var errorHandler, missingTagsFile, stream;
  ...
  return it("emit tags in chunks of the given size", function() {
    var dataHandler, endHandler, stream;
    stream = ctags.createReadStream(tagsFile, {
      chunkSize: 3
    });
