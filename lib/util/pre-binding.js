/**
 * Originally from https://github.com/mapbox/node-pre-gyp/tree/v0.6.19
 */
'use strict';
...
module.exports.find = function(package_json_path, opts) {
  try {
  ...
  var meta = evaluate(package_json, opts);
  return meta.module;
};
